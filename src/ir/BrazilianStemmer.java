...
public class BrazilianStemmer {
    ...
    public static ArrayList<String> stem(ArrayList<String> terms){
     ...
     * Residual suffix
     *
     * If the word ends with one of the suffixes (os a i o á í ó) in RV, delete
     * it
     *
     */
    private void step4() {
    ...
    /**
     * If the word ends with one of ( e é ê) in RV,delete it, and if preceded by
     * 'gu' (or 'ci') with the 'u' (or 'i') in RV, delete the 'u' (or 'i')
     *
